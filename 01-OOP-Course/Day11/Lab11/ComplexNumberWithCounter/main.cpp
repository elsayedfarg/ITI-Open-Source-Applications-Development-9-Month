...
public:
    ...
    ComplexNumber SubtractComplexNumbers(ComplexNumber c)
    {
        ComplexNumber Result;
...
//    PrintComplex(Sum);
    ...
    ComplexNumber Sub = c1.SubtractComplexNumbers(c2);
//    ComplexNumber Sub = SubtractComplexNumbers(c1, c2);
    cout << "\n\nSub Result : ";
    Sub.PrintComplex();
//    PrintComplex(Sub);

    cout << "\n\nTotal ComplexNumber objects created: "
         << ComplexNumber::GetCounter() << endl;
